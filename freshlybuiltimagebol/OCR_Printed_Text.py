from cv2 import fastNlMeansDenoisingColored,cvtColor,bitwise_not,threshold,getRotationMatrix2D,warpAffine,filter2D,imread,THRESH_BINARY,COLOR_BGR2GRAY,THRESH_OTSU,INTER_CUBIC,BORDER_REPLICATE,minAreaRect
